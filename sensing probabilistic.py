...
depth_pixel_horizontal_raster = int(rget_and_float('depth_pixel_horizontal_raster', 5)) #50
depth_pixel_vertical_raster = int(rget_and_float('depth_pixel_vertical_raster', 1)) #10
...
draw_obstacles = int(rget_and_float('draw_obstacles', 0))
...
try:
    while True:
        ...
        square_range = int(rget_and_float('square_range', 6))
        draw_grid = int(rget_and_float('draw_grid', 1))
        draw_obstacles = int(rget_and_float('draw_obstacles', 0)) #TODO
        max_climb_height = rget_and_float('max_climb_height', 10)
